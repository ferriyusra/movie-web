...
const AddShowtimeModal = ({ isOpen, onClose, refetchShowtimes }: PropTypes) => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (data: { movieId: string; theaterId: string; startTime: string; price: number }) =>
      showtimeServices.addShowtime({
        ...data,
    ...
    onSuccess: () => {
      ...
      onClose();
      refetchShowtimes();
      setToaster({ type: "success", message: "Showtime created!" });
    },
  });
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} size="lg">
      <form onSubmit={handleSubmit((data) => mutate(data))}>
        <ModalContent>
          <ModalHeader>Add Showtime</ModalHeader>
